import { App } from 'vue'
import { HomeOutlined, LinkOutlined, PlayCircleOutlined, BellOutlined, UserOutlined } from '@ant-design/icons-vue';
...
const logoComponents = [HomeOutlined, UserOutlined, PlayCircleOutlined, BellOutlined, LinkOutlined]
